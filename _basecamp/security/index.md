...
We also audit internal data access. If a {{site.trading_name}} employee wrongly accesses customer data, they will face penalties ranging from termination to prosecution. Again, to our knowledge, this hasn’t happened.
...
We’ve been around the block and we’ve seen a lot of companies come and go. Security isn’t just about technology, it’s about trust. Since 1999, we’ve worked hard to earn the trust of over hundreds of thousands of companies world wide. We’ll continue to work hard every day to maintain that trust. Longevity and stability is core to our mission at {{site.trading_name}}.

## Want to know more?

[We've got three pages of additional details in our security overview]({{site.trading_name}}-security-overview.pdf) for you. We take even further security steps with HEY. Go to [https://hey.com/security/](https://hey.com/security/) to learn more.
